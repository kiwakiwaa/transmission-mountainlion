...
- (NSComparisonResult)compareVersion:(NSString*)versionA toVersion:(NSString*)versionB
{
    ...
    // 5.0.1         -> 14719.0.199
    NSArray* versionBComponents = [versionB componentsSeparatedByString:@"."];
    if ([versionBComponents count] > 2 && [[versionBComponents objectAtIndex:2] integerValue] % 100 != 99 &&
    ...
    NSArray* versionAComponents = [versionA componentsSeparatedByString:@"."];
    for (NSUInteger idx = 0;[versionAComponents count] > idx || [versionBComponents count] > idx; idx++)
    {
        NSInteger vA = [versionAComponents count] > idx ? [[versionAComponents objectAtIndex:idx] integerValue] : 0;
        NSInteger vB = [versionBComponents count] > idx ? [[versionBComponents objectAtIndex:idx] integerValue] : 0;
        if (vA < vB)
        {
